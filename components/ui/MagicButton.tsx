...
const MagicButton = ({
  ...
  return (
    <button
      className="relative inline-flex h-12 w-[200px]   overflow-hidden p-[1px] focus:outline-none rounded-full "
      onClick={handleClick}
    >
      ...
      <span
        className={`inline-flex h-full w-[200px] cursor-pointer items-center justify-center 
